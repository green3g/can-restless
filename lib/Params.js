...
export const FilterMap = CanMap.extend({
  ...
  define: {
    ...
    /*
     * The operator to filter with. This value is set internally and serialized
     * for flask restless.
     * @property {String}
     */
    op: {
    ...
    /*
     * The value to filter by. This value is set internally and serialized for
     * flask-restless
     * @property {*} can-restless.FilterMap.val
     */
    val: {
      serialize(val) {
...
export const ParameterMap = CanMap.extend({
  ...
  define: {
    ...
    /**
     * An array of filters
     * @property {Array<FilterMap>} ParameterMap.props.sort
     * @parent ParameterMap.props
     */
    filters: {
      Type: FilterList,
     ...
     * @property {Number} ParameterMap.props.perPate
     * @parent ParameterMap.props
     */
    perPage: {
      type: 'number',
